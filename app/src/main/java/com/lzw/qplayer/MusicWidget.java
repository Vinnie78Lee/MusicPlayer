...
public class MusicWidget extends AppWidgetProvider {
    ...
    public static final String CHANGE_STATE = "com.lzw.musicplayer.CHANGE_STATE";
    public static final String  LAST_SONG= "com.lzw.musicplayer.LAST_SONG";
    public static final String NEXT_SONG="com.lzw.musicplayer.NEXT_SONG";
